                ...
                <section>
                    <div class="container" style="width: 100%">
                      <div class="heading" style="text-align: center">
                        ...
                        <p><b>UnderMu Server</b> es un juego online gratuito, que tiene como objetivo brindar entretenimiento a sus jugadores. Por favor, respeta las reglas para que podamos llevar una comunidad organizada, transparente y segura.</p>
                      </div>
                  ...
                  <ul>
                  <li><b>．</b>Jugar en UnderMu es totalmente GRATIS. Jamás te cobraremos por descargar el juego, ni por registrar una cuenta, ni por jugar. La adquisición de WCoins a través de donaciones es a absoluta elección de cada uno de los jugadores. Al realizar una donación NO le estás COMPRANDO a UnderMu Server , NI UnderMu Server te está VENDIENDO. TAMPOCO ESTÁS PAGANDO por un servicio. ÉSTAS APORTANDO DE MANERA VOLUNTARIA Y LIBRE al mantenimiento de una comunidad (UnderMu Server) por los siguientes años.</li>
                  ...
                  <li><b>．</b> Cada jugador es responsable del uso de sus WCoins. UnderMu Server no se hará responsable de una mala elección/edición de items a la hora de realizar una compra en la Webshop, obtención de membresías, cambio de nombre de personaje, compra en Tiendas Personales, etc.</li>
                  ...
                  <li><b>．</b> UnderMu Server pone a disposición del usuario la posibilidad de realizar donaciones utilizando plataformas de pagos de terceros (empresas tales como CuentaDigital, PayU, PayPal, MercadoPago, etc). UnderMu Server JAMÁS recibirá dinero de forma directa. El dinero de las donaciones NO lo recibirá UnderMu Server, sino las plataformas antes mencionadas. El control de cobros y pagos NO los maneja UnderMu Server, sino las plataformas antes mencionadas. UnderMu Server no podrá ser responsable ante una eventual falla en cualquiera de éstas plataformas.</li>
                  <li><b>．</b> Las donaciones se generan a través de plataformas de pago, las cuales gestionan las pasarelas de pago. Toda información ingresada en cada una de esas pasarelas, no es información que será almacenada en UnderMu Server bajo ninguna circustancia. Por tal motivo, UnderMu Server no podrá ser responsable ante un mal uso de esos datos ingresados en sistemas externos.</li>
