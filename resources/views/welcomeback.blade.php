...
<div class="container-fluid" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('img/fondo5.jpg'); height: 100vh;">
<div class="container text-center" style="margin-top: 60vh;">
    <div class="row">        
       <div class="col-md-12" >
           <p style="font-family:'Bowlby One SC', cursive;color:#237aff;font-size:60px;text-shadow: 2px 2px 2px black">UNDERMU <img src="img/logo.webp" style="height: 100px"> <span>SEASON 6 <p style="font-family:'Bowlby One SC', cursive;color:#237aff;font-size:60px;text-shadow: 2px 2px 2px black;font-size: 40px;">SPRINT 2</p>                                                                       
        </span>
     </div>      
    </div>
...
<div class="alert alert-info text-center">¿Querés arrancar pero no sabés si podés alcanzar el TOP? <a href="https://www.undermu.com/news?newid=33" target="_blank">Lee esta noticia </a></div>
        ...
        <div class="col-md-4">
            ...
            {{--<div class="panel">
			 ...
			 <div class="panel">
                ...
                <div class="panel-body">
                    @php 
                    $ultimos = DB::table('temas')->join('MEMB_INFO', 'temas.id_usuario', '=', 'MEMB_INFO.memb___id')->orderBy('temas.created_at', 'desc')->take(5)->get();
                    @endphp                
                    @foreach($ultimos as $ultimo)					
                        <p><a target="_blank" href="https://undermu.com/tema?id={{$ultimo->id}}">{{$ultimo->titulo}}</a> by {{$ultimo->memb_name}} </p>
